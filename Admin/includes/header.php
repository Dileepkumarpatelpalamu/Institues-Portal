...
<body class="bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#Contact">Contact List</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="galary_upload.php">Image Upload</a>
      </li>
...
<li class="nav-item">
        <a class="nav-link" href="user/index.php" tabindex="-1">User Management</a>
      </li>
      <li class="nav-item">
